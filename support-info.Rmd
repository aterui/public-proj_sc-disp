...
**Figure S4** Estimated mean dispersal distance in relation to body size and high flows. Panels distinguish species (BHC: bluehead chub, CRC: creek chub, STJ: striped jumprock) while colors represent presence-absence of high flows (flow events exceeding the 99th percentile of daily water levels). Shades indicate 95% credible intervals of estimated mean dispersal distance. Triangles indicate 20, 50, and 80th percentiles of total body length.
...
**Figure S5** Relocation history of selected individuals (10 individuals with > 5 (re)captures were randomly chosen). Colors distinguish individuals of each species (BHC: bluehead chub, CRC: creek chub, STJ: striped jumprock).